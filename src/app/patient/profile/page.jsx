...
export default function PatientProfile() {
 ...
 const session = useSession(); 
  ...
  const getSeverityColor = (severity) => {
    switch (severity) {
      case "Severe":
        return "bg-[#FF5656]/10 text-[#FF5656]";
      case "Moderate":
        return "bg-[#FFE27A]/10 text-[#FFE27A]";
      case "Mild":
        return "bg-[#56E0A0]/10 text-[#56E0A0]";
      default:
        return "bg-[#DDE1EC] text-[#8F96AA]";
    }
  };
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl border border-[#DDE1EC]">
        <div className="flex items-center justify-between p-6 border-b border-[#DDE1EC]">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-semibold text-[#1C243C]">
              Personal Information
            </h2>
          </div>
          <button
        ...
        <div className="p-6">
          <div className="mb-6 flex justify-center">
            {profileData.personal.profilePic ? (
              <img
                src={profileData.personal.profilePic}
                alt="Profile"
                className="w-24 h-24 rounded-full object-cover border-2 border-[#6B7AFF]/20"
              />
            ) : (
              <div className="w-24 h-24 rounded-full bg-[#DDE1EC] flex items-center justify-center">
                <RiUserLine className="w-12 h-12 text-[#8F96AA]" />
              </div>
            )}
          </div>
          ...
          {editingSection === "personal" ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2 flex justify-center mb-4">
                <label className="flex items-center gap-2 px-4 py-2 bg-[#6B7AFF]/10 text-[#6B7AFF] rounded-lg cursor-pointer hover:bg-[#6B7AFF]/20 transition-colors">
              ...
              <div>
                <label className="block text-sm font-medium text-[#1C243C] mb-2">
                  First Name
                </label>
                <input
                  type="text"
      ...
      <div className="bg-white rounded-xl border border-[#DDE1EC]">
        ...
        <div className="p-6 space-y-6">
          {/* Medical Conditions */}
          <div>
            <h3 className="font-medium text-[#1C243C] mb-4">
              Current Conditions
            </h3>
            <div className="space-y-3">
              {profileData.medical.conditions.map((condition) => (
                <div
                  key={condition.id}
                  className="flex items-center justify-between p-4 bg-[#F8F9FF] rounded-lg"
                >
                  <div>
                    <h4 className="font-medium text-[#1C243C]">
                      {condition.condition}
                    </h4>
        ...
        <div className="p-6">
          <div className="space-y-4">
            {profileData.medications.map((medication) => (
              <div
                key={medication.id}
                className="p-4 border border-[#DDE1EC] rounded-lg"
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="font-medium text-[#1C243C] mb-2">
                      {medication.name}
                    </h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-medium text-[#1C243C]">
                        {contact.name}
                      </h3>
                      {contact.isPrimary && (
