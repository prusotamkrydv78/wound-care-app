...
export default function RoleSelectionPage() {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2  bg-gradient-to-br from-pink-400 via-purple-500 to-blue-500 p-8 fixed h-screen">
        <div className="relative z-10 w-full flex flex-col justify-center max-w-xl mx-auto text-white">
          {/* Logo */}
      ...
      <div className="w-full lg:w-1/2 lg:ml-[50%] xl:ml-[50%] overflow-y-auto min-h-screen bg-white">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      <div className={`w-16 h-16 bg-gradient-to-br ${role.color} rounded-xl 
                        ...
                        <IconComponent className="w-16 h-8 text-white" />
                      </div>
                      <div>
                    ...
                    <div className="text-right">
                      {role.verificationRequired && (
                        <div className="text-xs text-[#818630] bg-[#FFE27A]/10 px-2 py-1 rounded mt-2">
